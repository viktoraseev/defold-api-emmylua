...
---
---Key                           Values
---format                        graphics.TEXTURE_FORMAT_LUMINANCEgraphics.TEXTURE_FORMAT_RGBgraphics.TEXTURE_FORMAT_RGBAgraphics.TEXTURE_FORMAT_DEPTHgraphics.TEXTURE_FORMAT_STENCILgraphics.TEXTURE_FORMAT_RGBA32Fgraphics.TEXTURE_FORMAT_RGBA16F
---width                         number
---height                        number
---min_filter (optional)         graphics.TEXTURE_FILTER_LINEARgraphics.TEXTURE_FILTER_NEAREST
---mag_filter (optional)         graphics.TEXTURE_FILTER_LINEARgraphics.TEXTURE_FILTER_NEAREST
---u_wrap     (optional)         graphics.TEXTURE_WRAP_CLAMP_TO_BORDERgraphics.TEXTURE_WRAP_CLAMP_TO_EDGEgraphics.TEXTURE_WRAP_MIRRORED_REPEATgraphics.TEXTURE_WRAP_REPEAT
---v_wrap     (optional)         graphics.TEXTURE_WRAP_CLAMP_TO_BORDERgraphics.TEXTURE_WRAP_CLAMP_TO_EDGEgraphics.TEXTURE_WRAP_MIRRORED_REPEATgraphics.TEXTURE_WRAP_REPEAT
...
---@param callback function(self, event_type)|nil A callback that receives all render related events. Pass nil if want to remove listener.
